...
A subclass of django.test.Client that additionally supports a ``json`` argument.  When provided, the content type of the request will be 'text/json', and the ``json`` argument will be JSON encoded and passed as the ``data``.
